...
namespace MyVideoTraining.Controllers
{
    public class PeopleController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "PersonId,PersonName,Address,Phone")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "PersonId,PersonName,Address,Phone")] Person person)
        {
            if (ModelState.IsValid)
            {
